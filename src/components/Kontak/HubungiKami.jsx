...
const HubungiKami = () => {
  return (
    <div className="w-full bg-no-repeat" style={{backgroundImage: `url(${bg_star})`}}>
        ...
        <div className="bg-white p-10 rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.1)]">
          ...
          <form className="space-y-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="nama" className="text-sm text-gray-800 font-bold">Nama</label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="telepon" className="text-sm text-gray-800 font-bold">Telepon</label>
                <input
                  type="text"
                  className="border p-3 rounded-md w-full bg-accent-3 border-transparent"
                  id="telepon"
            ...
            />
            <label htmlFor="subjek" className="text-sm text-gray-800 font-bold">Subjek</label>
            <input
              type="text"
              className="w-full border p-3 rounded-md bg-accent-3 border-transparent"
              id="subjek"
            />
            <label htmlFor="pesan" className="text-sm text-gray-800 font-bold">Pesan</label>
            <textarea
              rows="4"
