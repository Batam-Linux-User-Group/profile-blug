  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" style={{ filter: "blur(0px)" }}>
        ...
        <div className="container mx-auto px-6 py-20 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 gilroy-heavy">
              Tujuan Utama <span className="text-yellow-400">BLUG</span>
            </h1>

            {/* Quote marks and description */}
            <div className="max-w-2xl mx-auto mb-8">
              <div className="flex items-start gap-3">
                <div className="text-yellow-400 text-4xl font-bold leading-none">
                  "
                </div>
                <p className="text-gray-300 text-base leading-relaxed pt-2 gilroy-regular">
            ...
            {[
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center transition-opacity duration-700 group-hover:opacity-0" style={{ backgroundColor: "rgba(66, 66, 66, 0.5)" }}>
                  <div className="bg-yellow-400 w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                    {item.icon}
                  </div>
                  <h3 className="gilroy-heavy text-2xl mb-2 text-white">
                    {item.title}
                  </h3>
                  <div className="w-10 h-1 bg-yellow-400 mx-auto"></div>
                </div>
                ...
                >
                  <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                    ...
                    <div className="w-10 h-1 bg-yellow-400 mx-auto mt-4"></div>
                  </div>
                </div>

                {/* Border effect */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-yellow-400 rounded-lg transition-all duration-700"></div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center">
            <button className="bg-transparent border-2 border-yellow-400 text-yellow-400 px-6 py-2 rounded-full text-sm font-medium hover:bg-yellow-400 hover:text-black transition-all duration-300 transform hover:scale-105">
              Lihat Lebih Lanjut
            </button>
          </div>
        </div>
        ...
        <div className="absolute top-1/2 left-10 w-2 h-2 bg-yellow-400 rounded-full opacity-60"></div>
        <div className="absolute top-1/3 left-16 w-1 h-1 bg-yellow-400 rounded-full opacity-40"></div>
        <div className="absolute bottom-1/3 left-8 w-3 h-3 bg-yellow-400 rounded-full opacity-50"></div>
      </div>
    </div>
  );
};
