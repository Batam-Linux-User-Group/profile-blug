...
const Hero = ({ title, subTitle }) => {
  return (
    <>
    <div className="relative bg-cover bg-center flex h-187" style={{ backgroundImage: `url(${bgPoltek})` }}>
      ...
      <div className="lg:max-w-screen-lg mx-auto w-full z-10">
        <div className="pt-36">
          ...
          <div className="w-112">
            ...
            <img className="" src={garisVektor} alt="garis" />
            <h2 className="text-sm pb-3 text-gray-800 text-justify">
              {subTitle}
            </h2>
          </div>


          <div className="flex mt-4 items-center cursor-pointer bg-gray-800 pe-0.5 w-60 text-sm group space-x-6 rounded-full text-gray-200 justify-between hover:w-112 hover:bg-primary hover:text-gray-800 transition-all duration-600 ease-out">
      ...
      <div className="w-[45%] z-0 absolute right-0 bg-cover hidden md:block" style={{ backgroundImage: `url(${ellipse})` }} >
