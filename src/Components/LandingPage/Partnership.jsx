  ...
  return (
    <section>
      <div className='flex bg-primary w-full p-5 justify-center gap-30'>
        <img src={logo_crc} alt="Logo CRC" className='object-contain w-25 sm:w-50 h-auto' data-aos="fade-right" />
        <img src={logo_batamdev} alt="Logo Batam Dev" className='object-contain w-15 sm:w-30 h-auto' data-aos="fade-left" />
      </div>
      <div className='flex flex-col bg-secondary-dark pt-10 sm:pt-25 items-center'>
        <div className='bg-primary inline-block px-5 py-2 text-[0.5rem] sm:text-xs font-bold text-center' data-aos="flip-down">
          <p>Temui Tim Kami</p>
        </div>
        <h3 className='text-white font-black text-md sm:text-4xl my-5' data-aos="zoom-in">Badan Pengurus Harian BLUG 2025</h3>
      </div>
      <div className='flex w-full bg-secondary-dark relative'>
        <img src={bg_pengurus} alt="Pengurus" className='w-full h-auto' data-aos="fade-up" />
