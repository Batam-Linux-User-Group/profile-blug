...
import PopupWithPagination from "../../Components/Modal/Popup"; 
import {
  siber,
  programming,
  medin,
...
const divisions = [
  { title: "siber", label: "Divisi Siber", image: siber, icon: icons[0] },
  { title: "programming", label: "Divisi Programming", image: programming, icon: icons[1] },
  { title: "medin", label: "Divisi Medinfo", image: medin, icon: icons[2] },
  { title: "hrd", label: "Divisi HRD", image: inti, icon: icons[3] },
];
        ...
        <div className="flex flex-col gap-16">
          {divisions.map((div, index) => (
            <div
              ...
              className="relative group rounded-2xl shadow-xl cursor-pointer h-[580px] bg-transparent"
            >
              ...
              <div className="absolute top-10 left-1/2 transform -translate-x-1/2 z-20 text-center transition-transform duration-500 group-hover:scale-105">
                <h3 className="text-white font-bold text-2xl">{div.label}</h3>
              ...
              <div className="relative z-20 h-full w-full flex items-center justify-center mt-6 px-4">
                <img
                  src={div.image}
                  alt={div.label}
                  className="max-w-[85%] max-h-[85%] object-contain transition-transform duration-500 ease-in-out group-hover:scale-110"
                />
              </div>
            </div>
          ))}
